## rhythm/rhythm_game.gd

extends Node2D

var note = load("res://Scenes/Rhythm/note.tscn")
...
func _ready():
	...
	#$Conductor.play_from_beat(120,5)
...
func _on_Conductor_beat(position):
	...
	if song_position_in_beats > 98*2:
		...
		spawn_3_beat = 1
		spawn_4_beat = 0
	if song_position_in_beats > 110*2:
		spawn_1_beat = 3
		spawn_2_beat = 2
		spawn_3_beat = 3
		spawn_4_beat = 2
	...
	if song_position_in_beats > 162*2:
		...
		spawn_3_beat = 1
		spawn_4_beat = 2
	if song_position_in_beats > 189*2:
		spawn_1_beat = 1
		spawn_2_beat = 0
		spawn_3_beat = 2
		spawn_4_beat = 0
	...
	if song_position_in_beats > 527*2:
		...
		spawn_3_beat = 1
		spawn_4_beat = 1
	if song_position_in_beats > 533*2:
		spawn_1_beat = 0
		spawn_2_beat = 0
		spawn_3_beat = 0
		spawn_4_beat = 0
	if song_position_in_beats > 540*2:
